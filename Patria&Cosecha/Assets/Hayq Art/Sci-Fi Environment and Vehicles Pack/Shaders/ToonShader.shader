...
Shader "HayqArt/ToonShader"
{
	Properties
	{
		...
		[Toggle(_EMMISIONTOGGLE_ON)] _EmmisionToggle("EmmisionToggle", Float) = 0
	...
	SubShader
	{
		...
		#pragma target 3.0
		#pragma shader_feature_local _EMMISIONTOGGLE_ON
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			c.rgb = ( ( ( tex2D( _MainTex, uv_MainTex ) * tex2D( _ToonRamp, temp_cast_1 ) ) * ( ase_lightColor * float4( ( indirectDiffuse11 + ase_lightAtten ) , 0.0 ) ) ) + ( saturate( ( ( ase_lightAtten * dotResult3 ) * pow( ( 1.0 - saturate( ( dotResult38 + _RimOffset ) ) ) , _RimPower ) ) ) * ( _RimColor * ase_lightColor ) ) ).rgb;
			c.a = 1;
			return c;
		}
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			#ifdef _EMMISIONTOGGLE_ON
				float4 staticSwitch54 = tex2D( _Emmision, uv_Emmision );
			#else
				float4 staticSwitch54 = float4( 0,0,0,0 );
			#endif
			o.Emission = staticSwitch54.rgb;
		}
...
/*ASEBEGIN
Version=18935
919.2453;156.6792;1049.66;616.5849;-177.0175;118.997;1;True;False
...
Node;AmplifyShaderEditor.SamplerNode;53;500.7675,-36.19548;Inherit;True;Property;_Emmision;Emmision;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;54;867.0786,-28.092;Inherit;False;Property;_EmmisionToggle;EmmisionToggle;6;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=CE5E3F08CF73A4CE83903C75F02310E486AAACF3